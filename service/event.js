...
// Create User
eventService.register = async (req, res, next) => {
    userModel
...
// Login user
eventService.login = async (req, res, next) => {
    userModel
        .find({ email: req.body.email })
        .exec()
        .then(user => {
...
// Get All Users
eventService.findAll = async (req, res) => {
    try {
...
// Get User By ID
eventService.findOne = async (req, res) => {
    try {
...
// Update User By ID
eventService.update = async (req, res) => {
    try {
        let user = await userModel.findById(req.params.userId);
        if (!user) {
            return res
...
// Delete User By ID
eventService.delete = async (req, res) => {
    try {
